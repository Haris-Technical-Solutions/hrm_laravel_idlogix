                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="department_name" id="department_name" class="form-control <?php $__errorArgs = ['department_name'];
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('department_name', $department->department_name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="short_name" id="short_name" class="form-control <?php $__errorArgs = ['short_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('short_name', $department->short_name)); ?>" >
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" name="hod" id="hod" class="form-control <?php $__errorArgs = ['hod'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('hod', $department->hod)); ?>">
                                <?php $__errorArgs = ['hod'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
