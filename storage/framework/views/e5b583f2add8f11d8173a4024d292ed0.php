                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 justify-content-end d-flex">
                                    <a data-size="lg" data-url="<?php echo e(route('screenshots_create')); ?>" data-ajax-popup="true"
                                        ...
                                        data-title="<?php echo e(__('Create Screenshot')); ?>" class="btn btn-sm btn-primary">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\hrm_laravel_idlogix\Modules/LandingPage\Resources/views/landingpage/screenshots/index.blade.php ENDPATH**/ ?>