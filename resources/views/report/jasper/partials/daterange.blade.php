...
<div class="form-group">
    ...
    <div id="" class="input-group">
        <div class="input-group-prepend">
            <span class="input-group-text" id="basic-addon1"><i data-feather="calendar" width='25' height='25' class=" text-primary"></i></span>
        </div>
        ...
        $('#filter_date_range').daterangepicker(
            {
              ...
              startDate:{!! $timePicker ? "moment().startOf('hour')":"start" !!},
              endDate:{!! $timePicker ? "moment().startOf('hour').add(32, 'hour')":"end" !!},

                // startDate:@json($timePicker) ? moment().startOf('hour') : start,
                // endDate: @json($timePicker) ? moment().startOf('hour').add(32, 'hour') : end
                ...
                locale: {
                    cancelLabel: 'Clear',
                    // format:  {{$timePicker ? 'YYYY-MM-DD hh:mm A' : 'date_format'}},

                    format:  @json($timePicker) ? 'YYYY-MM-DD HH:mm:ss' : date_format,
